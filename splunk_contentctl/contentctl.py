...
def main(args):
    ...
    configure_parser = actions_parser.add_parser("configure", help="configure your splunk content, creates a custom contentctl.yml")
    init_parser = actions_parser.add_parser("init", help="initialize a splunk content project using a configuration created by the 'configure' option")
    ...
    configure_parser.add_argument("-o", "--output", required=False, type=argparse.FileType("w"), default='contentctl.yml' )
    configure_parser.set_defaults(func=configure)

    init_parser.add_argument("-s", "--skip_configuration", required=False, type=argparse.FileType("r"), default=False, help="Path to the config template generated by the 'configure' option.  Note that the default output is {DEFAULT_CONFIGURE_OUTPUT_FILE}")
